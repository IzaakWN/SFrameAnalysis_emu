...
Jet::Jet( const Ntuple::JetNtupleObject* ana, const Int_t idx ) : Basic( idx ), Particle(), m_isTagged( false ) {
...
ostream& operator<<( ostream& out, const Jet& rhs ) {
...
bool sortJetPt::operator()( const Jet& e1, const Jet& e2 ) {
