...
namespace Ntuple {
  ...
  ElectronNtupleObject::ElectronNtupleObject( SCycleBaseNTuple* parent ) : SInputVariables< SCycleBaseNTuple >( parent ) {
  ...
  void ElectronNtupleObject::ConnectVariables( const TString& treeName,
    ...
    if(  ((detail_level & Ntuple::ElectronBoostedIsolation) == Ntuple::ElectronBoostedIsolation)  ) {
      setConnectSucceeded(48, ConnectVariable( treeName, prefix + m_objectNames.getName("SemileptonicPFIso"), SemileptonicPFIso));
      setConnectSucceeded(49, ConnectVariable( treeName, prefix + m_objectNames.getName("SemileptonicCorrPFIso"), SemileptonicCorrPFIso));
