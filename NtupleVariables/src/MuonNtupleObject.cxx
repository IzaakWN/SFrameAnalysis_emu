...
if(  ((detail_level & Ntuple::MuonBoostedIsolation) == Ntuple::MuonBoostedIsolation)  ) {
     setConnectSucceeded(31, ConnectVariable( treeName, prefix + m_objectNames.getName("pfRhoCorrRelIso03Boost"), pfRhoCorrRelIso03Boost)); 
    setConnectSucceeded(32, ConnectVariable( treeName, prefix + m_objectNames.getName("pfRhoCorrRelIso04Boost"), pfRhoCorrRelIso04Boost)); 
    setConnectSucceeded(33, ConnectVariable( treeName, prefix + m_objectNames.getName("pfDeltaCorrRelIsoBoost"), pfDeltaCorrRelIsoBoost)); 
    setConnectSucceeded(34, ConnectVariable( treeName, prefix + m_objectNames.getName("pfRelIsoBoost"), pfRelIsoBoost)); 
    setConnectSucceeded(35, ConnectVariable( treeName, prefix + m_objectNames.getName("photonIsoBoost"), photonIsoBoost)); 
    setConnectSucceeded(36, ConnectVariable( treeName, prefix + m_objectNames.getName("neutralHadIsoBoost"), neutralHadIsoBoost)); 
    setConnectSucceeded(37, ConnectVariable( treeName, prefix + m_objectNames.getName("chargedHadIsoBoost"), chargedHadIsoBoost)); 
    setConnectSucceeded(38, ConnectVariable( treeName, prefix + m_objectNames.getName("SemileptonicPFIso"), SemileptonicPFIso)); 
    setConnectSucceeded(39, ConnectVariable( treeName, prefix + m_objectNames.getName("SemileptonicCorrPFIso"), SemileptonicCorrPFIso)); 
