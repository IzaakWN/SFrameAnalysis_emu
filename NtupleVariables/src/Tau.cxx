...
Tau::Tau( const Ntuple::TauNtupleObject* ana, const Int_t idx ) : Basic( idx ), Particle() {
  ...
  */
  ...
  if(  ((ana->detailLevel & Ntuple::TauAdvancedID) == Ntuple::TauAdvancedID)  ) {
    ...
    if (ana->m_connectsucceeded[28]) m_byLooseIsolationMVArun2v1PWnewDMwLT = ((*ana->byLooseIsolationMVArun2v1PWnewDMwLT)[idx]); else m_byLooseIsolationMVArun2v1PWnewDMwLT = 0; 
    if (ana->m_connectsucceeded[29]) m_byMediumIsolationMVArun2v1DBdR03oldDMwLT = ((*ana->byMediumIsolationMVArun2v1DBdR03oldDMwLT)[idx]); else m_byMediumIsolationMVArun2v1DBdR03oldDMwLT = 0; 
    if (ana->m_connectsucceeded[30]) m_byMediumIsolationMVArun2v1DBnewDMwLT = ((*ana->byMediumIsolationMVArun2v1DBnewDMwLT)[idx]); else m_byMediumIsolationMVArun2v1DBnewDMwLT = 0; 
    if (ana->m_connectsucceeded[31]) m_byMediumIsolationMVArun2v1DBoldDMwLT = ((*ana->byMediumIsolationMVArun2v1DBoldDMwLT)[idx]); else m_byMediumIsolationMVArun2v1DBoldDMwLT = 0; 
    if (ana->m_connectsucceeded[32]) m_byMediumIsolationMVArun2v1PWnewDMwLT = ((*ana->byMediumIsolationMVArun2v1PWnewDMwLT)[idx]); else m_byMediumIsolationMVArun2v1PWnewDMwLT = 0; 
    if (ana->m_connectsucceeded[33]) m_byTightIsolationMVArun2v1DBdR03oldDMwLT = ((*ana->byTightIsolationMVArun2v1DBdR03oldDMwLT)[idx]); else m_byTightIsolationMVArun2v1DBdR03oldDMwLT = 0; 
    if (ana->m_connectsucceeded[34]) m_byTightIsolationMVArun2v1DBnewDMwLT = ((*ana->byTightIsolationMVArun2v1DBnewDMwLT)[idx]); else m_byTightIsolationMVArun2v1DBnewDMwLT = 0; 
    if (ana->m_connectsucceeded[35]) m_byTightIsolationMVArun2v1DBoldDMwLT = ((*ana->byTightIsolationMVArun2v1DBoldDMwLT)[idx]); else m_byTightIsolationMVArun2v1DBoldDMwLT = 0; 
    if (ana->m_connectsucceeded[36]) m_byTightIsolationMVArun2v1PWnewDMwLT = ((*ana->byTightIsolationMVArun2v1PWnewDMwLT)[idx]); else m_byTightIsolationMVArun2v1PWnewDMwLT = 0; 
    if (ana->m_connectsucceeded[37]) m_byVLooseIsolationMVArun2v1DBdR03oldDMwLT = ((*ana->byVLooseIsolationMVArun2v1DBdR03oldDMwLT)[idx]); else m_byVLooseIsolationMVArun2v1DBdR03oldDMwLT = 0; 
    if (ana->m_connectsucceeded[38]) m_byVLooseIsolationMVArun2v1DBnewDMwLT = ((*ana->byVLooseIsolationMVArun2v1DBnewDMwLT)[idx]); else m_byVLooseIsolationMVArun2v1DBnewDMwLT = 0; 
    if (ana->m_connectsucceeded[39]) m_byVLooseIsolationMVArun2v1DBoldDMwLT = ((*ana->byVLooseIsolationMVArun2v1DBoldDMwLT)[idx]); else m_byVLooseIsolationMVArun2v1DBoldDMwLT = 0; 
    if (ana->m_connectsucceeded[40]) m_byVLooseIsolationMVArun2v1PWnewDMwLT = ((*ana->byVLooseIsolationMVArun2v1PWnewDMwLT)[idx]); else m_byVLooseIsolationMVArun2v1PWnewDMwLT = 0; 
    if (ana->m_connectsucceeded[41]) m_byVTightIsolationMVArun2v1DBdR03oldDMwLT = ((*ana->byVTightIsolationMVArun2v1DBdR03oldDMwLT)[idx]); else m_byVTightIsolationMVArun2v1DBdR03oldDMwLT = 0; 
    if (ana->m_connectsucceeded[42]) m_byVTightIsolationMVArun2v1DBnewDMwLT = ((*ana->byVTightIsolationMVArun2v1DBnewDMwLT)[idx]); else m_byVTightIsolationMVArun2v1DBnewDMwLT = 0; 
    if (ana->m_connectsucceeded[43]) m_byVTightIsolationMVArun2v1DBoldDMwLT = ((*ana->byVTightIsolationMVArun2v1DBoldDMwLT)[idx]); else m_byVTightIsolationMVArun2v1DBoldDMwLT = 0; 
    if (ana->m_connectsucceeded[44]) m_byVTightIsolationMVArun2v1PWnewDMwLT = ((*ana->byVTightIsolationMVArun2v1PWnewDMwLT)[idx]); else m_byVTightIsolationMVArun2v1PWnewDMwLT = 0; 
    if (ana->m_connectsucceeded[45]) m_byVVTightIsolationMVArun2v1DBdR03oldDMwLT = ((*ana->byVVTightIsolationMVArun2v1DBdR03oldDMwLT)[idx]); else m_byVVTightIsolationMVArun2v1DBdR03oldDMwLT = 0; 
    if (ana->m_connectsucceeded[46]) m_byVVTightIsolationMVArun2v1DBnewDMwLT = ((*ana->byVVTightIsolationMVArun2v1DBnewDMwLT)[idx]); else m_byVVTightIsolationMVArun2v1DBnewDMwLT = 0; 
    if (ana->m_connectsucceeded[47]) m_byVVTightIsolationMVArun2v1DBoldDMwLT = ((*ana->byVVTightIsolationMVArun2v1DBoldDMwLT)[idx]); else m_byVVTightIsolationMVArun2v1DBoldDMwLT = 0; 
    if (ana->m_connectsucceeded[48]) m_byVVTightIsolationMVArun2v1PWnewDMwLT = ((*ana->byVVTightIsolationMVArun2v1PWnewDMwLT)[idx]); else m_byVVTightIsolationMVArun2v1PWnewDMwLT = 0; 
    if (ana->m_connectsucceeded[49]) m_againstElectronMVA6raw = &((*ana->againstElectronMVA6raw)[idx]); else m_againstElectronMVA6raw = 0; 
    if (ana->m_connectsucceeded[50]) m_againstElectronMVA6category = &((*ana->againstElectronMVA6category)[idx]); else m_againstElectronMVA6category = 0; 
    if (ana->m_connectsucceeded[51]) m_againstElectronVLooseMVA6 = ((*ana->againstElectronVLooseMVA6)[idx]); else m_againstElectronVLooseMVA6 = 0; 
    if (ana->m_connectsucceeded[52]) m_againstElectronLooseMVA6 = ((*ana->againstElectronLooseMVA6)[idx]); else m_againstElectronLooseMVA6 = 0; 
    if (ana->m_connectsucceeded[53]) m_againstElectronMediumMVA6 = ((*ana->againstElectronMediumMVA6)[idx]); else m_againstElectronMediumMVA6 = 0; 
    if (ana->m_connectsucceeded[54]) m_againstElectronTightMVA6 = ((*ana->againstElectronTightMVA6)[idx]); else m_againstElectronTightMVA6 = 0; 
    if (ana->m_connectsucceeded[55]) m_againstElectronVTightMVA6 = ((*ana->againstElectronVTightMVA6)[idx]); else m_againstElectronVTightMVA6 = 0; 
    if (ana->m_connectsucceeded[56]) m_againstMuonLoose3 = ((*ana->againstMuonLoose3)[idx]); else m_againstMuonLoose3 = 0; 
    if (ana->m_connectsucceeded[57]) m_againstMuonTight3 = ((*ana->againstMuonTight3)[idx]); else m_againstMuonTight3 = 0; 
    if (ana->m_connectsucceeded[58]) m_byPhotonPtSumOutsideSignalCone = &((*ana->byPhotonPtSumOutsideSignalCone)[idx]); else m_byPhotonPtSumOutsideSignalCone = 0; 
