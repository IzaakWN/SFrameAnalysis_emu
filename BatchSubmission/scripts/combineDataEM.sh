...
echo
echo ">>> hadd MuonEG" &&
ls -lt MuonEG/*_?_*${LABEL}.root && echo &&
hadd -f MuonEG/TauTauAnalysis.MuonEG_Run2016${FINAL_LABEL}.root MuonEG/TauTauAnalysis.MuonEG_?_Run2016${LABEL}.root ||
echo ">>> Warning! Could not find MuonEG root files!"
