...
void ScaleFactorTool::BeginInputData( const SInputData& ) throw( SError ) {
  ...
  m_logger << INFO << "Efficiency file Mu27 Trig:      "        << m_File_Mu27Trig          << SLogger::endmsg;
...
// float ScaleFactorTool::get_Efficiency_MuTauTrig_MC(double pt1, double eta1, double pt2, double eta2, int dm, bool isRealTau, std::string triggerFlags){
//   
//   // assume:
...
// 
// 
// float ScaleFactorTool::get_Efficiency_MuTauTrig_Data(double pt1, double eta1, double pt2, double eta2, int dm, bool isRealTau, std::string triggerFlags){
//   
//   // assume:
//   //  - eff(X) = eff(l*tau) = eff(l)*eff(tau)
//   //  - single lepton (L) fired  =>  lepton leg (l) of cross-trigger fired
...
// 
// 
// float ScaleFactorTool::get_ScaleFactor_MuTauTrig(double pt1, double eta1, double pt2, double eta2, int dm, int genmatch_2, std::string triggerFlags){
...
// 
// 
// float ScaleFactorTool::get_ScaleFactor_MuTauTrig_OR(double pt1, double eta1, double pt2, double eta2, int dm, int genmatch_2, std::string triggerFlags){
...
float ScaleFactorTool::get_ScaleFactor_Mu27Trig(double pt, double eta){
  return m_ScaleFactor_Mu27Trig->get_ScaleFactor(pt,eta);
}



float ScaleFactorTool::get_ScaleFactor_MuIdIso(double pt, double eta){
  return m_ScaleFactor_MuId->get_ScaleFactor(pt,eta)*m_ScaleFactor_MuIso->get_ScaleFactor(pt,eta);
}



float ScaleFactorTool::get_ScaleFactor_MuId(double pt, double eta){
...
// float ScaleFactorTool::get_ScaleFactor_Mu22Trig(double pt1, double eta1){
//   return m_ScaleFactor_Mu22Trig->get_ScaleFactor(pt1,eta1);
// }
// 
// 
...
// 
// 
// float ScaleFactorTool::get_Efficiency_EleTauTrig_MC(double pt1, double eta1, double pt2, double eta2, int dm, bool isRealTau, std::string triggerFlags){
//   
//   // assume:
//   //  - eff(X) = eff(l*tau) = eff(l)*eff(tau)
//   //  - single lepton (L) fired  =>  lepton leg (l) of cross-trigger fired
...
// 
// 
// float ScaleFactorTool::get_Efficiency_EleTauTrig_Data(double pt1, double eta1, double pt2, double eta2, int dm, bool isRealTau, std::string triggerFlags){
//   
//   // assume:
//   //  - eff(X) = eff(l*tau) = eff(l)*eff(tau)
//   //  - single lepton (L) fired  =>  lepton leg (l) of cross-trigger fired
...
// 
// 
// float ScaleFactorTool::get_ScaleFactor_EleTauTrig(double pt1, double eta1, double pt2, double eta2, int dm, int genmatch_2, std::string triggerFlags){
//   // numerical protection: SF = min(1.e+1, P_data / P_MC)
...
// 
// 
// float ScaleFactorTool::get_ScaleFactor_EleTauTrig_OR(double pt1, double eta1, double pt2, double eta2, int dm, int genmatch_2, std::string triggerFlags){
