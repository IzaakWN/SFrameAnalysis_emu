...
histPref['ZTT'] = {'style':sHTT_DYJets, 'layer':4, 'legend':'Z#rightarrow#tau#tau (M > 50)'}
...
histPref['TT'] = {'style':sHTT_TTJets, 'layer':3, 'legend':'t#bar{t}'} 
histPref['TTT'] = {'style':sHTT_TTJets, 'layer':3, 'legend':'t#bar{t}_T'} 
histPref['TTJ'] = {'style':sHTT_TTJets, 'layer':3, 'legend':'t#bar{t}_J'} 
