...
from Style import sBlue,sBlack
    ...
    def Draw(self, opt='',
        ...
        for hist in self.hists:
            ...
            if self.totalHist is None:
                ...
                self.totalHist.Add( hist )
        self._Draw( opt, self.hists, xmin, xmax, ymin, ymax, factor)

    def _Draw( self, opt, hists, xmin, xmax, ymin, ymax, factor):
        ...
        if ymin is None:
            ymin = 0.1
        if ymax is None:
            ymax = hist.GetMaximum()*factor
#            ymax = hist.GetMaximum()*1.9
